...
func loadFederatedClientFromConfig(config *restclient.Config) (*unversionedfederation.FederationClient, error) {
...
func LoadFederatedClient() (*unversionedfederation.FederationClient, error) {
	config, err := LoadFederatedConfig()
	if err != nil {
		return nil, fmt.Errorf("error creating client: %v", err.Error())
	}
	return loadFederatedClientFromConfig(config)
}
